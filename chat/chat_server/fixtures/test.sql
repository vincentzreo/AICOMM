...
VALUES
    (
        ...
        'zzq@zzq.com',
        'zzq',
        '$argon2id$v=19$m=19456,t=2,p=1$6oJfE3UiponQts0znvyM4g$MLggmVmAxtLBi7uqAh6LSTotu2isSpYsCnO660jbfdE'
    ),
    (
        1,
        'a@zzq.com',
...
INSERT INTO
    chat_agents (chat_id, name, type, prompt, args)
VALUES
    (
        1,
        'translation',
        'proxy',
        'if content is in english, translate to chinese.if language is chinese, translate to english',
        '{}'
    );
